      ...
      <div className="container relative pt-20 sm:pt-56 lg:pt-64 pb-12 sm:pb-48 lg:pb-48 mx-auto">
        <div className="flex flex-col lg:flex-row justify-center items-center">
          ...
          <div className="lg:pl-8 pt-8 sm:pt-10 lg:pt-0">
            <h1 className="font-header text-secondary text-4xl sm:text-5xl md:text-6xl text-center sm:text-left">
              Hello, I'm <span className="text-primary">Eric Swanson!</span>
            </h1>
